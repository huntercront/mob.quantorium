...
document.addEventListener('DOMContentLoaded', function(){
	if($('div').hasClass('slider-slides')){
		...
		var heroSlider = new SiemaWithDots({
			...
			function currentSlideinit() {
				...
				setTimeout(function(){
					$('.slider-slides').eq(1).addClass('anim-text');
				  }, 10);
	...
	if($('div').is('.blog-slides')){
		...
		var blogRight = new Siema({
			...
			function initSlider(){
				$('.blog-right-slide').removeClass('hide-on-load')
			}
			
		$('.brs-slider-prev').click(function() {
		blogRight.prev()
		})
